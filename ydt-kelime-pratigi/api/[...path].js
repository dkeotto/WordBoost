/**
 * Vercel Serverless: tüm /api/* isteklerini BACKEND_URL (Railway vb.) üzerindeki Express’e iletir.
 * Ortam değişkeni Vercel Project → Settings → Environment Variables: BACKEND_URL=https://xxx.railway.app
 */
