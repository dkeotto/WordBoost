    ...
    body: (
      <>
        ...
        <ul>
          ...
          <li>
            <strong>Favoriler:</strong> Kelime, synonym ve phrasal öğelerini ayrı kümelerde saklayın. Sınav öncesi veya
            iş İngilizcesi için kendi müfredatınızı oluşturun; tek dokunuşla çalışmaya dönün.
          </li>
          <li>
