    ...
    <div className="login-overlay">
      ...
      <div className="login-modal">
        ...
        <div className="login-buttons">
          ...
          <button className="btn-google" onClick={() => alert("Google Login entegrasyonu için backend yapılandırması gereklidir.")}>
          ...
          <button className="btn-apple" onClick={() => alert("Apple Login entegrasyonu için backend yapılandırması gereklidir.")}>
            <svg viewBox="0 0 24 24" width="24" height="24" xmlns="http://www.w3.org/2000/svg"><path fill="currentColor" d="M17.05 20.28c-.98.95-2.05.88-3.08.4-1.09-.5-2.08-.48-3.24.02-1.44.62-2.2.44-3.06-.48C2.7 15.25 3.68 7.59 10.5 7.39c1.67 0 2.8.85 3.5.85.7 0 2.4-1.05 4.3-.8 1.58.13 2.5 1.13 3.2 2.15-2.9 1.75-2.4 5.25.6 6.45-.4 1.4-1.2 3.1-2.05 4.24zM13 7.5c.1-2.35 2.1-4.4 4.25-4.5.3 2.5-2.35 4.5-4.25 4.5z"/></svg>
            Continue with Apple
          </button>
